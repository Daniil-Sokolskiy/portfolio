...
#define modem_power_Pin GPIO_PIN_0
#define modem_power_GPIO_Port GPIOA
#define reboot_Pin GPIO_PIN_11
#define reboot_GPIO_Port GPIOB
#define int1_Pin GPIO_PIN_13
#define int1_GPIO_Port GPIOB
#define int2_Pin GPIO_PIN_14
#define int2_GPIO_Port GPIOB
#define dry_Pin GPIO_PIN_15
#define dry_GPIO_Port GPIOB
